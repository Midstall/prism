...
pub const drm = if (builtin.target.os.tag != .freestanding) @import("platform/drm.zig") else struct {};
pub const wayland = if (builtin.target.os.tag != .freestanding) @import("platform/wayland.zig") else struct {};
...
pub const gbm = if (builtin.target.os.tag != .freestanding) @import("platform/gbm.zig") else struct {};
